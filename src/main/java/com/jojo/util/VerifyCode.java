...
public class VerifyCode {
    ...
    public static Integer getVerifyCode(String telPhone){
        ...
        NameValuePair[] data = {//提交短信
                new NameValuePair("account", "C27838423"), //查看用户名是登录用户中心->验证码短信->产品总览->APIID
                new NameValuePair("password", "694c272f3920940822a4082db1be4a0d"),  //查看密码请登录用户中心->验证码短信->产品总览->APIKEY
